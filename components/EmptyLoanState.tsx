  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-50 mb-3 text-center"
      >
        No Loan Plans Yet
      </motion.h2>
      ...
      <motion.p
        ...
        className="text-base text-slate-600 dark:text-slate-300 mb-8 text-center max-w-md"
      >
      ...
      <motion.div
        ...
        className="mt-8 flex flex-wrap items-center justify-center gap-4 text-xs text-slate-500 dark:text-slate-300"
      >
