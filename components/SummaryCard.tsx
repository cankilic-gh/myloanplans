          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            {onPaidMonthsChange && (
              <div className="flex items-center gap-3">
                <Label htmlFor="paidMonthsSummary" className="text-sm font-medium text-slate-700 dark:text-slate-300 whitespace-nowrap">
                  Paid Months:
                </Label>
                <select
                  ...
                  className="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-800 hover:border-primary focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors text-slate-900 dark:text-slate-100"
                >
