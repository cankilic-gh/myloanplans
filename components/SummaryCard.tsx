            ...
            {onPaidMonthsChange && (
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="px-3 py-2 border border-slate-300 rounded-lg text-sm bg-white hover:border-primary focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors"
                >
