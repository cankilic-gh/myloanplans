  ...
  return (
    <>
      <div className="bg-white rounded-lg border border-slate-200 shadow-lg overflow-hidden">
        ...
        >
          <span className="text-sm font-semibold text-slate-700">Recurring Expenses / Income</span>
        ...
        <AnimatePresence>
          {expanded && (
            ...
            >
              <div className="border-t border-slate-100 p-4 flex flex-col min-h-0" style={{ minHeight: "200px" }}>
                {/* Tabs */}
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60]">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Delete Recurring Item</h3>
